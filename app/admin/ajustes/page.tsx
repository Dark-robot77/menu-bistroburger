export default function AjustesPage() {
  return <PendingSection title="AJUSTES" fase="Fase 5" desc="Logo, color de marca, dirección, teléfono e Instagram del restaurante. Generación automática de QR por mesa." />
}
